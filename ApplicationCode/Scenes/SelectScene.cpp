...
const float SelectScene::easingTime = 150.0f;
...
void SelectScene::Update()
{
	...
	tutorial_->SetPos({ 640.0f, Easing::easeOut(easingTimer_ , easingTime, tutorial_->GetPos().y, tutorialLastPos) });
	stage1_->SetPos({ 640.0f, Easing::easeOut(easingTimer_, easingTime, stage1_->GetPos().y, stage1LastPos) });
	stageSelectWindow_->SetPosition({ 640.0f, Easing::easeOut(easingTimer_, easingTime, stageSelectWindow_->GetPosition().y, stageSelectWindowLastPos) });
	tutorial_->Update();
	stage1_->Update();
