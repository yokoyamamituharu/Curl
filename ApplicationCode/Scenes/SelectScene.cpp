...
const float SelectScene::easingTime = 40.0f;
...
void SelectScene::Update()
{
	...
	tutorial_->SetPos({ 640.0f, Easing::easeOut(easingTimer_ , easingTime, tutorialLastPos, tutorial_->GetPos().y) });
	stage1_->SetPos({ 640.0f, Easing::easeOut(easingTimer_, easingTime, stage1LastPos, stage1_->GetPos().y) });
	stageSelectWindow_->SetPosition({ 640.0f, Easing::easeOut(easingTimer_, easingTime, stageSelectWindowLastPos, stageSelectWindow_->GetPosition().y) });
	tutorial_->Update();
	stage1_->Update();
